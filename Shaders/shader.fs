...
const Light light0=Light(vec3(0.0f,21.5f,55.5f),vec3(1.0f,1.0f,1.0f));
const Light light1=Light(vec3(25.0f,21.5f,0.0f),vec3(1.0f,1.0f,1.0f));
const Light light2=Light(vec3(-25.0f,21.5f,0.0f),vec3(1.0f,1.0f,1.0f));
const Light light3=Light(vec3(40.0f,21.5f,-55.5f),vec3(1.0f,1.0f,1.0f));
...
const Material material=Material(0.11f,0.3f,0.2f,10.0f);
